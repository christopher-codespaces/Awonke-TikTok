...
const SignUp = () =>{
  return (
    ...
    <div className="bg-gray-300 px-6 py-8 rounded shadow-md text-black w-full">
      ...
      <button
        type="submit"
        className="w-full text-center py-3 rounded bg-green-500   focus:outline-none my-1 text-white	bg-black"
      > Login   </button>

      <div className="text-center text-sm text-gray-600 mt-4">
        Do not have an account? 
        <span className="no-underline   text-gray-   font-bold   "                     href="#">
        Create account         
        </span> 
